...
//Judul
$pdf -> Cell (70,8,'Laporan Pengeluaran Kas',0,1,'L');
...
while ($hasil = mysqli_fetch_array($tampil)){
    ...
    $pdf -> Cell(30,6,$hasil['nama_dibayar'],1,0,'C');
    $pdf -> Cell(30,6,$hasil['cara_bayar'],1,0,'C');
    $pdf -> Cell(40,6,$hasil['no_rekening'],1,0,'C');
    $pdf -> Cell(20,6,'IDR',1,0,'C');
    $pdf -> Cell(20,6,'1.00',1,0,'C');
    $pdf -> Cell(30,6,'Rp. '.number_format($hasil['total_bayar']),1,0,'C');
